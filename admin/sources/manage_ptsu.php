...
<div class=\"site_title\">Manage PTSU Offers</div>
...
echo "</td>
        <td align=\"center\">";
echo $paginator->linkorder("approved", "Approved");
echo " / ";
echo $paginator->linkorder("pending", "Pending");
echo "</td>
        <td align=\"center\">";
...
while ($r = $db->fetch_array($q)) {
	...
	echo $r['id'];
	echo "\"><img src=\"./css/images/clock.png\" border=\"0\" title=\"View pending requests\" /></a>
        </td>
    </tr>
    ";
}
