...
<div class=\"site_title\">Manage Withdrawals</div>
...
echo "</td>
        <td align=\"center\">";
echo $paginator->linkorder("account", "Account");
echo "</td>
        <td align=\"center\">";
...
<table width=\"100%\" class=\"widget-tbl\">
	...
	echo "</td>
        <td align=\"right\">Rented Referrals:</td>
        <td style=\"color:#990000\">";
	...
	echo "    <div class=\"widget-title\" style=\"margin-top:5px\">Action</div>
        <div class=\"widget-content\">
        	<select name=\"a\">
                ...
                <option value=\"process\">Set as Completed</option>
                <option value=\"cancel\">Set as Canceled</option>
