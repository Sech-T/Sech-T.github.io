...
$pp_currencies = array("USD" => "US Dollars", "EUR" => "Euro", "AUD" => "Australian Dollar", "CAD" => "Canadian Dollar", "GBP" => "Pound Sterling", "JPY" => "Japanese Yen", "NZD" => "New Zealand Dollar", "CHF" => "Swiss Franc", "HKD" => "Hong Kong Dollar", "SGD" => "Singapore Dollar", "SEK" => "Swedish Krona", "DKK" => "Danish Krone", "PLN" => "Polish Zloty", "NOK" => "Norwegian Krone", "HUF" => "Hungarian Forint", "CZK" => "Czech Koruna", "ILS" => "Israeli Shekel", "MXN" => "Mexican Peso", "BRL" => "Brazilian Real", "MYR" => "Malaysian Ringgit", "PHP" => "Philippine Pesos", "TWD" => "Taiwan New Dollars", "THB" => "Thai Baht");
