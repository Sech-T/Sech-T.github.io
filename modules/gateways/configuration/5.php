...
$ep_currencies = array("USD" => "US Dollars", "EUR" => "Euro");
echo "<form method=\"post\" id=\"frm";
echo $r['id'];
echo "\" onsubmit=\"return submitform(this.id);\">
	<table width=\"100%\" class=\"widget-tbl\">
    	<tr>
        	<td align=\"right\" width=\"200\">Store ID:</td>
            <td><input type=\"text\" name=\"account\" value=\"";
echo $r['account'];
echo "\" /></td>
        </tr>
    	<tr>
        	<td align=\"right\">Store Password:</td>
            <td><input type=\"text\" name=\"option1\" value=\"";
echo $r['option1'];
echo "\" /></td>
        </tr>
    	<tr>
        	<td align=\"right\">Checksum Key:</td>
            <td><input type=\"text\" name=\"option6\" value=\"";
echo $r['option6'];
echo "\" /></td>
        </tr>
...
echo "</td>
    	...
    	<tr>
            ...
            <td style=\"color:#000099\">";
echo $settings['site_url'];
echo "modules/gateways/epstatus.php</td>
        </tr>
    	<tr>
