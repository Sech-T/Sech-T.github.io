...
echo "\" onsubmit=\"return submitform(this.id);\">
	<table width=\"100%\" class=\"widget-tbl\">
    	<tr>
        	<td align=\"right\" width=\"200\">Shop ID:</td>
...
echo "modules/gateways/payeer_success.php</td>
        </tr>
    	<tr>
        	<td align=\"right\">Fail Url:</td>
            <td style=\"color:#000099\">";
echo $settings['site_url'];
echo "modules/gateways/payeer_fail.php</td>
        </tr>
    	<tr>
        	<td align=\"right\">Status Url:</td>
            <td style=\"color:#000099\">";
echo $settings['site_url'];
echo "modules/gateways/payeer_status.php</td>
        </tr>
    	<tr>
...
echo $r['min_deposit'];
echo "\" /> (Amount should be higher than 1)</td>
        </tr>
    	<tr>
...
echo "\" />%</td>
    	...
    	<tr>
        	<td align=\"right\">Payeer Account:</td>
