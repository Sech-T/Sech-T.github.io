    ...
    <div id="tab-1">
        ...
        <table width="100%" class="tbl-content" cellpadding="4">
            <tr>
                ...
                <td><strong>${$user_info.money}</strong></td>
            ...
            <tr>
                ...
                <td><strong>${$user_info.purchase_balance}</strong></td>
...
{if $smarty.session.user_verified != 1}
