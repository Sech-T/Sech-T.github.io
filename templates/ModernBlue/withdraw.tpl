...
function showgateways(id){
    ...
    <div id="paymentgateways" align="center">
    	<div class="padding5" align="left">{$lang.txt.select_payment_method}:</div>
...
<tr>
    ...
    <td>${$mymembership.max_withdraw}</td>
</tr>
{/if}
<tr>
	<td align="right">{$lang.txt.withdrawfee}:</td>
    <td>{$gateway[n].withdraw_fee}% + ${$gateway[n].withdraw_fee_fixed}</td>
</tr>
<tr id="total">
